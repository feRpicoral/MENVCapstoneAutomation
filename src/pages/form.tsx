...
export default function Form() {
    ...
    return (<>
        ...
        <Box m={5}>
            <Stack spacing={1}>
                <LoginPrompt>
                    {projects.length == 0 ? (<Typography variant='h6'>No projects have been configured yet, please do so to continue</Typography>) :
                        <>
                            ...
                            <Typography variant='body1'>
                                This tool will create and set up the form for you; you can delete and remake it as many
                                times
                            ...
                            {sheetSuccess &&
                                <Typography variant='body1'>Sheet was created successfully. It will be used in later
                                    steps, you don't need to do anything to it.</Typography>}
